...
import com.powertrain.ecu.obd.reader.trips.TripListAdapter;
...
public class TripListActivity
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(com.powertrain.ecu.obd.reader.R.layout.activity_trips_list);

        ListView lv = (ListView) findViewById(com.powertrain.ecu.obd.reader.R.id.tripList);
    ...
    public boolean onOptionsItemSelected(MenuItem item) {
        ...
        if (id == com.powertrain.ecu.obd.reader.R.id.action_settings) {
            return true;
        }
    ...
    public void onCreateContextMenu(ContextMenu menu, View v,
        ...
        // create the menu
        getMenuInflater().inflate(com.powertrain.ecu.obd.reader.R.menu.context_trip_list, menu);
    ...
    public boolean onContextItemSelected(MenuItem item) {
        ...
        switch (item.getItemId()) {
            case com.powertrain.ecu.obd.reader.R.id.itemDelete:
