...
public class ConfigActivity extends PreferenceActivity implements OnPreferenceChangeListener {
     ...
     */
        addPreferencesFromResource(com.powertrain.ecu.obd.reader.R.xml.preferences);
    ...
    private void hideGPSCategory() {
        ...
        PreferenceCategory preferenceCategory = (PreferenceCategory) findPreference(getResources().getString(com.powertrain.ecu.obd.reader.R.string.pref_gps_category));
